...
<nav class="navbar navbar-expand-md navbar-light  sticky-top navbar-custom shadow p-3 mb-5 " style="background-color:#242C42;">
  ...
  <li class="nav-item">
    <a class="nav-link" href="http://localhost/Tutorial%20Point/userzone/CSS/css.php">CSS</a>
  </li>
  <li class="nav-item">
    <a class="nav-link"  href="#contact">JAVASCRIPT</a>
  </li>
<li class="nav-item">
    <a class="nav-link" href="#home">BOOTSRTAP</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#profile">PHP</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#contact">ANDROID</a>
  </li>
  <li class="nav-item">
    <a class="nav-link"  href="#home" >Python</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#profile" >JAVA</a>
  </li>
...
<ul class ="nav navbar-nav">
     <P style="font-size:20px; font-weight:500; letter-spacing:2px;">HTML TUTORIALS</P>
<li class ="nav-item">
<a class ="nav-link" href="#">Introduction to  HTML </a>
</li>
<li class ="nav-item">
<a class ="nav-link" href="#">Getting Start HTML</a>
</li>
<li class ="nav-item">
<a class ="nav-link" href="#">HTML Element</a>
</li>
<li class ="nav-item">
<a class ="nav-link" href="#">HTML Atribute</a>
</li>
 <li class ="nav-item">
<a class ="nav-link" href="#">HTML Heading</a>
</li>
<li class ="nav-item">
<a class ="nav-link" href="#">HTML Paragraph</a>
</li>
</ul>
</nav>  
    </div>
		<div class="col-sm-7" style="background-color:white; padding-top:27px; ">
			<h3 class="" style="text-align:left; margin-top:20px; margin-left:12px;">Introduction to HTML</h3>
      <img src="image/html.png" class="img-thumbnail" style="margin-top:20px;">
      <p style="text-align:justify; font-size:20px; padding:12px;">
        HTML is stands for Hyper text markup language. Hypertext means link one to  another page,markup means formating,language means language.it is used to create a static webpage  It allows the user to create and structure sections, paragraphs, headings, links, and blockquotes for web pages and applications.<br>
        HTML is not a programming language. It was devoloped by Team Berners lea in 1991 </p>
