...
<head>
	...
	<title>welcome to smart programing</title>
...
<li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link" href="#profile" y>JAVA</a>
  </li>
...
<ul class ="nav navbar-nav">
     <P style="font-size:20px; font-weight:500; letter-spacing:2px;">WEB TUTORIALS</P>
<li class ="nav-item">
<a class ="nav-link" href="http://localhost/Tutorial%20Point/userzone/HTML/html.php#"> HTML </a>
</li>
<li class ="nav-item">
...
<a class ="nav-link" href="#">BOOTSTRAP </a>
  ...
  <P style="font-size:20px; font-weight:500; letter-spacing:2px;">PRACTICAL EXAMPLES</P>
  <li class ="nav-item">
<a class ="nav-link" href="#"> HTML EXAMPLE</a>
</li>
<li class ="nav-item">
<a class ="nav-link" href="#">CSS EXAMPLE</a>
</li>
<li class ="nav-item">
<a class ="nav-link" href="#"> PHP EXAMPLE</a>
</li>
<li class ="nav-item">
<a class ="nav-link" href="#">BOOTSTRAP EXAMPLE</a>
</li>
</ul>
</nav>  
    </div>
