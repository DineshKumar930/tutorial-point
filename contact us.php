...
<body>
    ...
    <div class="container-fluid" style="background-color:#242C42; margin-top:0px;">
			<div class="row" style="padding:10px;">
				<div class="col-sm-4 text-center text-white"><h5>Welcome to my online learning point</h5></div>
  ...
  <a class="navbar-brand" href=""><img src="image/logo-1.png" alt="" style="height:50px; width:250px; margin:5px;"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
        <a class="nav-link text-uppercase" href="file:///C:/Users/prince%20kumar/Desktop/Tutorials/registraition.html#">Register</a>
      </li>
      <!-- Megamenu-->
...
<div class="signup-form">
	...
	<br>
		...
		<div class="form-group">
            <button type="submit" name="login" class="btn btn-primary btn-lg">Sign Up</button>
        </div>
         <p class="text-center">Create New Account &nbsp; &nbsp;<a href="http://localhost/Tutorial%20Point/register.php?">click here</a></p>
    </form>
</div>
</body>
</html>